...
ARG MAPD_FILE="mapd-ce-latest-Linux-x86_64-render"
ARG PYGDF_COMMIT="c2595fd"
ARG LIBGDF_COMMIT="21d35dc"
ARG PYMAPD_COMMIT="b69edef"
...
# Install MapD
RUN wget https://builds.mapd.com/ce/mapd-ce-latest-Linux-x86_64-render.tar.gz && \
    mkdir -p $MAPD_DIR && \
...
# add pytorch
RUN /bin/bash -c "source activate pycudf_notebook_py35 && conda install pytorch torchvision -c pytorch"
